package com.noxyee.task.exception

import com.noxyee.task.exception.model.ErrorResponse
...
class ExceptionHandler {
    ...
    fun handleNoteNotFoundException(e: TaskNotFoundException): ResponseEntity<String> {
